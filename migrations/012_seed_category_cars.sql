-- Ensure companies exist before seeding cars
...
-- Seed cars for all categories
-- Company IDs:
--   a2000000-...-001 = Alpha Rent a Car (Erbil)
--   a2000000-...-002 = Baghdad Auto Rental (Baghdad)
--   a2000000-...-003 = Basra Car Hire (Basra)

-- ============ LUXURY ============
INSERT INTO cars (company_id, make, model, year, price_per_day, city, category, image_url, description) VALUES
  ('a2000000-0000-0000-0000-000000000001', 'Mercedes-Benz', 'S-Class', 2024, 250000, 'Erbil', 'luxury',
   'https://images.unsplash.com/photo-1618843479313-40f8afb4b4d8?w=800&q=80',
   'The pinnacle of luxury. Mercedes S-Class with massaging seats, ambient lighting, and premium sound system.'),
  ('a2000000-0000-0000-0000-000000000002', 'BMW', '7 Series', 2023, 230000, 'Baghdad', 'luxury',
   'https://images.unsplash.com/photo-1555215695-3004980ad54e?w=800&q=80',
   'Executive luxury at its finest. BMW 7 Series with rear entertainment, heated seats, and night vision.'),
  ('a2000000-0000-0000-0000-000000000003', 'Audi', 'A8', 2023, 220000, 'Basra', 'luxury',
   'https://images.unsplash.com/photo-1606664515524-ed2f786a0bd6?w=800&q=80',
   'Audi A8 with quattro all-wheel drive, virtual cockpit, and Bang & Olufsen audio.'),
  ('a2000000-0000-0000-0000-000000000001', 'Lexus', 'LS 500', 2023, 210000, 'Erbil', 'luxury',
...
-- ============ EXOTIC ============
INSERT INTO cars (company_id, make, model, year, price_per_day, city, category, image_url, description) VALUES
  ('a2000000-0000-0000-0000-000000000001', 'Porsche', '911 Carrera', 2024, 350000, 'Erbil', 'exotic',
   'https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=800&q=80',
   'Iconic Porsche 911 Carrera. Twin-turbo flat-six, sport chrono package, and launch control.'),
  ('a2000000-0000-0000-0000-000000000002', 'Lamborghini', 'Huracan', 2023, 500000, 'Baghdad', 'exotic',
   'https://images.unsplash.com/photo-1544636331-e26879cd4d9b?w=800&q=80',
   'Turn every head on the road. Lamborghini Huracan with V10 engine and all-wheel drive.'),
  ('a2000000-0000-0000-0000-000000000001', 'Ferrari', 'Roma', 2023, 450000, 'Erbil', 'exotic',
  ...
  ('a2000000-0000-0000-0000-000000000003', 'Maserati', 'GranTurismo', 2023, 380000, 'Basra', 'exotic',
...
-- ============ CLASSIC ============
INSERT INTO cars (company_id, make, model, year, price_per_day, city, category, image_url, description) VALUES
  ('a2000000-0000-0000-0000-000000000001', 'Ford', 'Mustang GT', 1967, 200000, 'Erbil', 'classic',
   'https://images.unsplash.com/photo-1494976388531-d1058494cdd8?w=800&q=80',
   'Iconic 1967 Ford Mustang GT fastback. Fully restored, V8 engine, classic American muscle.'),
  ('a2000000-0000-0000-0000-000000000002', 'Chevrolet', 'Camaro SS', 1969, 220000, 'Baghdad', 'classic',
   'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=800&q=80',
   'Classic 1969 Camaro SS with big block V8. A true collector piece available for special occasions.'),
  ('a2000000-0000-0000-0000-000000000003', 'Mercedes-Benz', '300SL', 1955, 300000, 'Basra', 'classic',
   'https://images.unsplash.com/photo-1583121274602-3e2820c69888?w=800&q=80',
   'The legendary Mercedes 300SL Gullwing. Perfect for weddings, photoshoots, and special events.');

-- ============ LIMOUSINE ============
INSERT INTO cars (company_id, make, model, year, price_per_day, city, category, image_url, description) VALUES
  ('a2000000-0000-0000-0000-000000000001', 'Lincoln', 'Town Car Limo', 2022, 300000, 'Erbil', 'limousine',
  ...
  ('a2000000-0000-0000-0000-000000000002', 'Cadillac', 'Escalade Limo', 2023, 350000, 'Baghdad', 'limousine',
  ...
  ('a2000000-0000-0000-0000-000000000003', 'Mercedes-Benz', 'V-Class VIP', 2023, 280000, 'Basra', 'limousine',
...
-- ============ ECONOMY ============
INSERT INTO cars (company_id, make, model, year, price_per_day, city, category, image_url, description) VALUES
  ('a2000000-0000-0000-0000-000000000001', 'Toyota', 'Yaris', 2023, 40000, 'Erbil', 'economy',
  ...
  ('a2000000-0000-0000-0000-000000000002', 'Suzuki', 'Swift', 2022, 35000, 'Baghdad', 'economy',
  ...
  ('a2000000-0000-0000-0000-000000000003', 'Kia', 'Picanto', 2023, 30000, 'Basra', 'economy',
   'https://images.unsplash.com/photo-1609521263047-f8f205293f24?w=800&q=80',
   'Kia Picanto — the ultimate city car. Low fuel costs and easy handling for everyday errands.'),
  ('a2000000-0000-0000-0000-000000000002', 'Hyundai', 'i10', 2022, 32000, 'Baghdad', 'economy',
...
-- ============ VAN ============
INSERT INTO cars (company_id, make, model, year, price_per_day, city, category, image_url, description) VALUES
  ('a2000000-0000-0000-0000-000000000001', 'Toyota', 'HiAce', 2023, 130000, 'Erbil', 'van',
  ...
  ('a2000000-0000-0000-0000-000000000002', 'Hyundai', 'H1', 2022, 110000, 'Baghdad', 'van',
  ...
  ('a2000000-0000-0000-0000-000000000003', 'Ford', 'Transit', 2023, 120000, 'Basra', 'van',
...
-- ============ MORE SUVs ============
INSERT INTO cars (company_id, make, model, year, price_per_day, city, category, image_url, description) VALUES
  ('a2000000-0000-0000-0000-000000000001', 'Range Rover', 'Sport', 2024, 200000, 'Erbil', 'suv',
   'https://images.unsplash.com/photo-1606016159991-dfe4f2746ad5?w=800&q=80',
   'Range Rover Sport with dynamic air suspension, meridian sound, and terrain response system.'),
  ('a2000000-0000-0000-0000-000000000002', 'BMW', 'X5', 2023, 180000, 'Baghdad', 'suv',
  ...
  ('a2000000-0000-0000-0000-000000000003', 'Mercedes-Benz', 'GLE', 2023, 190000, 'Basra', 'suv',
...
-- ============ MORE SEDANS ============
INSERT INTO cars (company_id, make, model, year, price_per_day, city, category, image_url, description) VALUES
  ('a2000000-0000-0000-0000-000000000001', 'Honda', 'Accord', 2023, 80000, 'Erbil', 'sedan',
  ...
  ('a2000000-0000-0000-0000-000000000002', 'Mazda', '6', 2023, 78000, 'Baghdad', 'sedan',
   'https://images.unsplash.com/photo-1580273916550-e323be2ae537?w=800&q=80',
   'Mazda 6 with SkyActiv technology. Premium feel with excellent driving dynamics.');

-- ============ MORE PICKUPS ============
INSERT INTO cars (company_id, make, model, year, price_per_day, city, category, image_url, description) VALUES
  ('a2000000-0000-0000-0000-000000000001', 'Ford', 'Ranger', 2023, 115000, 'Erbil', 'pickup',
   'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?w=800&q=80',
   'Ford Ranger Wildtrak with 4WD, bed liner, and tow package. Ready for any terrain.'),
  ('a2000000-0000-0000-0000-000000000002', 'Mitsubishi', 'L200', 2022, 100000, 'Baghdad', 'pickup',
