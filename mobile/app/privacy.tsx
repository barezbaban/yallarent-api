  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.body}>{t('privacy.s1Body')}</Text>

        <Text style={styles.sectionTitle}>{t('privacy.s2Title')}</Text>
        <Text style={styles.body}>{t('privacy.s2Body')}</Text>

        <Text style={styles.sectionTitle}>{t('privacy.s3Title')}</Text>
        <Text style={styles.body}>{t('privacy.s3Body')}</Text>

        <Text style={styles.sectionTitle}>{t('privacy.s4Title')}</Text>
        <Text style={styles.body}>{t('privacy.s4Body')}</Text>

        <Text style={styles.sectionTitle}>{t('privacy.s5Title')}</Text>
        <Text style={styles.body}>{t('privacy.s5Body')}</Text>

        <Text style={styles.sectionTitle}>{t('privacy.s6Title')}</Text>
        <Text style={styles.body}>{t('privacy.s6Body')}</Text>

        <Text style={styles.sectionTitle}>{t('privacy.s7Title')}</Text>
        <Text style={styles.body}>{t('privacy.s7Body')}</Text>
      </ScrollView>
    </SafeAreaView>
  );
}
